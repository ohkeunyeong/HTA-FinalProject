...
INSERT INTO REVIEW(REVIEW_COUNT, PRODUCT_CODE, CATEGORY_CODE, PRODUCT_NAME, REVIEW_CONTENT ,
REVIEW_IMG, REVIEW_DATE, MEMBER_NICK, REVIEW_STAR)
VALUES('1', '000001', '600', '주말 장바구니(소)', '튼튼하고 좋아요', '', sysdate, 'user1', '4');

INSERT INTO REVIEW(REVIEW_COUNT, PRODUCT_CODE, CATEGORY_CODE, PRODUCT_NAME, REVIEW_CONTENT ,
REVIEW_IMG, REVIEW_DATE, MEMBER_NICK, REVIEW_STAR)
VALUES('2','000003', '300', '대유 모두나와(500ml)', '효과가 아주 좋습니다. 벌레때문에 많이 고생했는데 많이 줄었어요.', '', sysdate, 'user2', '5');