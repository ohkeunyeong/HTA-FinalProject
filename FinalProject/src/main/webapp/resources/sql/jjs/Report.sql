...
insert into REPORT
values(report_seq.nextval, 1, 'asd', '부적절한 게시물로 신고합니다.', 'jik', sysdate);

insert into REPORT
values(report_seq.nextval, 2, 'asd', '부적절한 게시물로 신고합니다.', 'work', sysdate);

insert into REPORT
values(report_seq.nextval, 2, 'asd', '부적절한 게시물로 신고합니다.', 'work', sysdate);

insert into REPORT
values(report_seq.nextval, 3, 'asd', '부적절한 게시물로 신고합니다.', 'free', sysdate);

insert into REPORT
values(report_seq.nextval, 4, 'asd', '부적절한 게시물로 신고합니다.', 'free', sysdate);
