...
<div class="container nav">
		<ul class="nav nav-tabs nav-justified">
			...
			<li class="nav-item"><a class="nav-link active" href="${pageContext.request.contextPath}products/list?category_code=400">농기구</a></li>
...
<div class="container">	
			<div class="tools">
		 <c:forEach items="${toolsList1}" var="tools" varStatus="status">
