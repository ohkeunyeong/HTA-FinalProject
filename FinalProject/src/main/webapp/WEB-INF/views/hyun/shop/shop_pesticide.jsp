...
<div class="container nav">
		<ul class="nav nav-tabs nav-justified">
			...
			<li class="nav-item"><a class="nav-link active" href="${pageContext.request.contextPath}/products/list?category_code=300">살충제</a>
			</li>
...
<div class="container">
<br><br>
  <h4>우리 농장에 해충은 못온다! 살충제 제품</h4>
</div>

<div class="container">	
		<div class="pesticide">
		 <c:forEach items="${pesticideList1}" var="pesticide" varStatus="status">
		  ...
		  <div class="products card-deck">
			...
			<div class="card" style="width:20%" >
				<img class="card-img-top" style="height:300px;"
					src="${pageContext.request.contextPath}/resources/image/hyun/${pesticide.product_img}"
					alt="Card image"style="width: 100%; height:300px;">
				<div class="card-body">
					<h5 class="card-title">${pesticide.product_name}</h5>
					<p class="card-text">${pesticide.product_detail}</p>
					<a href="shop/shop_detail?product_code=${pesticide.product_code}" class="btn btn-info">제품 보기</a>
				</div>
			</div>
