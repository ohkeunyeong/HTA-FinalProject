	...
	<nav class="navbar navbar-expand-sm bg-success navbar-dark fixed-top main-header">
		...
		<ul class="navbar-nav navbar-expand-sm" style="width:30%;">
			...
			<c:if test="${!empty id}">
				...
				<div class="dropdown-menu">
					<a class="dropdown-item" href="${pageContext.request.contextPath}/member/updatebefore">정보수정</a> <a class="dropdown-item" href="#">게시글덧글관리</a> <a class="dropdown-item" href="${pageContext.request.contextPath}/member/userOrderView">구매관리</a> <a class="dropdown-item" href="${pageContext.request.contextPath}/cart/list?id=${id}">장바구니</a>
				</div></li>
				</c:if>
			</c:if>
