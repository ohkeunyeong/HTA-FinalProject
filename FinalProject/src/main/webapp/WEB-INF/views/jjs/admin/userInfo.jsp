              ...
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>내농장</b> <a class="float-right">JavaFarm</a>
                  </li>
                  <li class="list-group-item">
                    <b>회원등급</b> <a class="float-right">농장멤버</a>
                  </li>
                  <li class="list-group-item">
                    <b>닉네임</b> <a class="float-right">javas</a>
                  </li>
                  <li class="list-group-item">
                    <b>이메일</b> <a class="float-right">javas@naver.com</a>
                  </li>
                  <li class="list-group-item">
                    <b>전화번호</b> <a class="float-right">010-9999-9999</a>
                  </li>
                </ul>

                <button class="btn btn-danger btn-block" data-toggle="modal" data-target="#userDeleteModal"><b>회원삭제</b></button>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
