	            		...
	            		<div class="col12 col-sm-6">
	            			<div class="col-12 mt-3">
	            				<div class="input-group">
	            					...
	            					<input type="text" id="farmname" class="form-control">
	            				</div>
	            			</div>
	            			<div class="col-12 mt-3">
	            				<div class="input-group">
	            					<label for="farmadmin" class="mt-2">농장관리자</label>&nbsp;
	            					<input type="text" id="farmname" class="form-control">
	            				</div>
	            			</div>
	            			<div class="col-12 mt-3">
	            				<div class="input-group">
	            					<label for="farmname" class="mt-2">농장지역</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	            					<input type="text" id="farmadmin" class="form-control">
	            				</div>
	            			</div>
	            			<div class="col-12 mt-3">
	            				<div class="input-group">
	            					<label for="farmusercount" class="mt-2">농장인원수</label>&nbsp;
	            					<input type="text" id="farmusercount" class="form-control">
	            				</div>
	            			</div>
	            			<div class="col-12 mt-3 mb-3">
	            				<div class="input-group">
	            					<label for="farmdate" class="mt-2">농장등록일</label>&nbsp;
	            					<input type="text" id="farmdate" class="form-control">
	            				</div>
	            			</div>
	            		</div>
	            	</div>
