				...
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-lg-6">
							...
							<div class="card card-primary">
								<div class="card-header">
									<span>농장목록</span> <a class="float-right" href="farmList">더보기></a>
								</div>
								<div class="card-body">
									<table class="table table-striped table-bordered">
										<thead>
						...
						<div class="col-lg-6">
							<div class="card card-primary">
								<div class="card-header">
									<span>주말장터 관리</span> <a class="float-right" href="productList">더보기></a>
								</div>
								<div class="card-body">
									<table class="table table-striped table-bordered">
										<thead>
							...
							<div class="card card-primary">
								<div class="card-header">
									<span>주문목록</span> <a class="float-right" href="orderList">더보기></a>
								</div>
								<div class="card-body">
									<table class="table table-striped table-bordered">
										<thead>
