...
<body>
  ...
  <div class="container">
 	<table class="table">
 		...
 		<tr>
 			<td colspan="2" class="noborder right"> 작성 시간 : ${jikdata.jik_date}  조회수 : ${jikdata.jik_readcount}  좋아요 : ${jikdata.jik_like}
  ...
  <div id="slideShow">
   <ul class="slides"> 
   		<li><img width="300" src="../resources/image/chang/remove" alt=""></li>
