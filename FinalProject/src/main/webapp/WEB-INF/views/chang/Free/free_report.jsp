...
.form-control:disabled, .form-control[readonly] {
	...
	<script>
	$(function(){
	$('#board_num').val(opener.document.getElementById('free_num').value);
	$('#board_id').val(opener.document.getElementById('free_id').value);
	$('#board_subject').val(opener.document.getElementById('free_subject').value);
	$('#board_content').val(opener.document.getElementById('free_content').value);
	
	$("#submit").on("click",function()
	{	$.ajax(
		{
			url : '${pageContext.request.contextPath}/report/reportAdd',
			type:"POST",
...
<body>
  <div class="container">
   <form method="post" id="report" name="report">
     ...
     <input type="hidden" name="board_table" id="board_table" value="free">
